...
data <- dplyr::sample_frac(data, 0.33, replace = FALSE)
...
Any of the c50 with one trial, or the random forest with parameter mtry = 4, obtains perfect accuracy and Kappa. 
But we know that is too good to be true (the workd is random, not deterministic), so the models are over fitting the data.
