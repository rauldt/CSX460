...
df_airports <- read.csv(paste0(data_path,"02-building-blocks/02-exercise-nycflights/data/airports.csv"))
df_flights <- read.csv(paste0(data_path,"02-building-blocks/02-exercise-nycflights/data/flights.csv"))
df_planes <- read.csv(paste0(data_path,"02-building-blocks/02-exercise-nycflights/data/planes.csv"))
df_weather <- read.csv(paste0(data_path,"02-building-blocks/02-exercise-nycflights/data/weather.csv"))
...
df_merged <- 
 left_join(df_flights, df_weather, by = "origin") %>%
   left_join(df_planes, by = "tailnum") %>%
     left_join(df_airports, by = "origin")
